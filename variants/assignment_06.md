# Домашнее задание: Проектирование ML-системы — Задание 6
...
6. **Рекомендации вакансий:** Спроектируйте систему для сайта профессиональной сети, которая будет рекомендовать вакансии пользователям. Сосредоточьтесь на сопоставлении профилей пользователей с описаниями вакансий и решении проблемы холодного старта для новых пользователей.
...
- Задержка (latency) ответа не должна превышать **153 мс**.
- Система должна обслуживать **4,517,205 активных пользователей в день (DAU)**, с пиковой нагрузкой в **10,428 запросов в секунду (RPS)**.
