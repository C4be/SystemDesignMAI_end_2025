# Домашнее задание: Проектирование ML-системы — Задание 5
...
5. **Рекомендации подкастов:** Спроектируйте систему для рекомендации подкастов на основе истории прослушивания и контента (аудио транскрипты). Сосредоточьтесь на контентной и коллаборативной фильтрации.
...
- Задержка (latency) ответа не должна превышать **299 мс**.
- Система должна обслуживать **3,243,340 активных пользователей в день (DAU)**, с пиковой нагрузкой в **14,367 запросов в секунду (RPS)**.
