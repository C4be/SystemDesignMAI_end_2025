...
1. **Промышленный контроль качества:** Спроектируйте систему для обнаружения дефектов в продуктах на высокоскоростной сборочной линии. Основное внимание уделите низкой задержке и высокой точности.
...
- Задержка (latency) ответа не должна превышать **348 мс**.
- Система должна обслуживать **1,124,316 активных пользователей в день (DAU)**, с пиковой нагрузкой в **17,760 запросов в секунду (RPS)**.
