# Домашнее задание: Проектирование ML-системы — Задание 14
...
14. **Обнаружение мошенничества с кредитными картами:** Спроектируйте систему реального времени для обнаружения мошеннических транзакций. Сосредоточьтесь на обработке несбалансированных данных и выводе с низкой задержкой.
...
- Задержка (latency) ответа не должна превышать **365 мс**.
- Система должна обслуживать **3,787,926 активных пользователей в день (DAU)**, с пиковой нагрузкой в **18,320 запросов в секунду (RPS)**.
