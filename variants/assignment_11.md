# Домашнее задание: Проектирование ML-системы — Задание 11
...
11. **Поиск людей в социальной сети:** Спроектируйте систему для ранжирования людей в результатах поиска. Сосредоточьтесь на функциях социального графа и персонализации.
...
- Задержка (latency) ответа не должна превышать **263 мс**.
- Система должна обслуживать **2,875,856 активных пользователей в день (DAU)**, с пиковой нагрузкой в **5,332 запросов в секунду (RPS)**.
