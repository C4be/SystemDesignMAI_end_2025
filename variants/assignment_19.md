# Домашнее задание: Проектирование ML-системы — Задание 19
...
19. **Обнаружение фейковых отзывов:** Спроектируйте систему для обнаружения и удаления фейковых отзывов на сайте с обзорами товаров. Сосредоточьтесь на анализе текста, поведения пользователей и графовых признаков.
...
- Задержка (latency) ответа не должна превышать **435 мс**.
- Система должна обслуживать **3,598,581 активных пользователей в день (DAU)**, с пиковой нагрузкой в **16,370 запросов в секунду (RPS)**.
