# Домашнее задание: Проектирование ML-системы — Задание 18
...
18. **Модерация изображений, загружаемых пользователями:** Спроектируйте систему для торговой площадки, чтобы предотвратить загрузку запрещенных товаров (например, оружия, подделок). Сосредоточьтесь на классификации изображений и активном обучении для обработки новых типов запрещенных товаров.
...
- Задержка (latency) ответа не должна превышать **328 мс**.
- Система должна обслуживать **3,325,962 активных пользователей в день (DAU)**, с пиковой нагрузкой в **14,065 запросов в секунду (RPS)**.
