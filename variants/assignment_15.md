# Домашнее задание: Проектирование ML-системы — Задание 15
...
15. **Прогнозирование оттока клиентов:** Для сервиса подписки (например, Netflix или SaaS) спроектируйте систему для прогнозирования, какие пользователи, скорее всего, уйдут. Сосредоточьтесь на инженерии признаков из журналов активности пользователей.
...
- Задержка (latency) ответа не должна превышать **377 мс**.
- Система должна обслуживать **3,971,279 активных пользователей в день (DAU)**, с пиковой нагрузкой в **7,374 запросов в секунду (RPS)**.
