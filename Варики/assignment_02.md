# Домашнее задание: Проектирование ML-системы — Задание 2
...
2. **Мониторинг в сельском хозяйстве:** Спроектируйте систему с использованием изображений с дронов для выявления болезней сельскохозяйственных культур. Сосредоточьтесь на обработке больших объемов изображений и обновлении моделей.
...
- Задержка (latency) ответа не должна превышать **490 мс**.
- Система должна обслуживать **4,673,977 активных пользователей в день (DAU)**, с пиковой нагрузкой в **2,334 запросов в секунду (RPS)**.
