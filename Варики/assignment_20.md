# Домашнее задание: Проектирование ML-системы — Задание 20
...
20. **Обнаружение дипфейков:** Спроектируйте систему для обнаружения дипфейк-видео на платформе для обмена видео. Сосредоточьтесь на анализе видеокадров и выявлении артефактов, характерных для дипфейков.
...
- Задержка (latency) ответа не должна превышать **223 мс**.
- Система должна обслуживать **4,884,165 активных пользователей в день (DAU)**, с пиковой нагрузкой в **7,345 запросов в секунду (RPS)**.
