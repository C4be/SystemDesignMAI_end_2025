...
3. **Умный ритейл:** Спроектируйте систему для создания тепловой карты движения покупателей в супермаркете. Основное внимание уделите обработке в реальном времени и конфиденциальности (размытие лиц).
...
- Задержка (latency) ответа не должна превышать **259 мс**.
- Система должна обслуживать **1,377,775 активных пользователей в день (DAU)**, с пиковой нагрузкой в **5,557 запросов в секунду (RPS)**.
