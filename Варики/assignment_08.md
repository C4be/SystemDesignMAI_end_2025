# Домашнее задание: Проектирование ML-системы — Задание 8
...
8. **Рекомендации туристических направлений:** Спроектируйте систему для рекомендации туристических пакетов (авиабилеты + отели) на основе предпочтений и бюджета пользователя. Сосредоточьтесь на многокритериальной оптимизации (цена, рейтинг, время в пути).
...
- Задержка (latency) ответа не должна превышать **188 мс**.
- Система должна обслуживать **2,729,055 активных пользователей в день (DAU)**, с пиковой нагрузкой в **6,225 запросов в секунду (RPS)**.
