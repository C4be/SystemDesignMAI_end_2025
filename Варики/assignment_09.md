# Домашнее задание: Проектирование ML-системы — Задание 9
...
9. **Ранжирование в поиске ресторанов:** Спроектируйте систему для ранжирования ресторанов на основе запроса пользователя (например, «суши рядом со мной»). Факторы должны включать релевантность, расстояние, рейтинг и цену. Сосредоточьтесь на обучении ранжированию (Learning-to-Rank, LTR).
...
- Система должна обслуживать **3,046,433 активных пользователей в день (DAU)**, с пиковой нагрузкой в **2,238 запросов в секунду (RPS)**.
